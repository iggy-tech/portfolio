...
const projects = [
  {
    title: "Uploadify",
    description: "File uploading service for the web",
    date: "2024-2025",
    image: "/images/uploadify.png",
  },
  {
    title: "FeatureBase",
    description: "Collect feedback on your ideas",
    date: "2024-2025",
  ...
  {
    title: "Ternary",
    description: "Monetize your discord server",
    date: "2024-2025",
    image: "/images/ternary.jpg",
  },
  {
    title: "Ecomify",
          ...
          <div className="md:flex md:gap-x-10 items-center md:pt-28">
            ...
            >
              ...
              <p className="text-muted-foreground text-lg md:pr-8">
                I have a{" "}
                <LinkPreview
                  url="https://www.youtube.com/@igor8424"
